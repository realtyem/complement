...
func TestRoomMessages(t *testing.T) {
	...
	alicePassword := "aliceBr0keTheLookingGla55"
	bobPassword := "B0bsY0urUncle"
	charliePassword := "Charlie54ngel5WereC00l"

	t.Run("Parallel", func(t *testing.T) {
		// sytest: POST /rooms/:room_id/send/:event_type sends a message
		// sytest: GET /rooms/:room_id/messages returns a message
		t.Run("SendAndFetchMessage", func(t *testing.T) {
			//formerly TestSendAndFetchMessage
			// with users: @t01alice:hs1
		...
		t.Run("FetchMessagesFromNonExistentRoom", func(t *testing.T) {
			//formerly TestFetchMessagesFromNonExistentRoom
			// with users: @t02alice:hs1
			t.Parallel()
		...
		t.Run("SendMessageWithTxn", func(t *testing.T) {
			//formerly TestSendMessageWithTxn
			// with users: @t03alice:hs1
			t.Parallel()
		...
		t.Run("LazyLoading", func(t *testing.T) {
			//formerly TestRoomMessagesLazyLoading
			// with users: @t04alice:hs1, @t04bob:hs1 and @t04charlie:hs1
			t.Parallel()
			...
			charlie := deployment.RegisterUser(t, "hs1", "t04charlie", charliePassword, false)
		...
		t.Run("LazyLoadingLocalUser", func(t *testing.T) {
			//formerly TestRoomMessagesLazyLoadingLocalUser
			// with users: @t05alice:hs1
			t.Parallel()
