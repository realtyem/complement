...
func testSyncLeaveSection(t *testing.T, deployment *docker.Deployment) {
	alice := deployment.NewUser(t, "tSyncArchive01alice", "hs1")
...
func testGappedSyncLeaveSection(t *testing.T, deployment *docker.Deployment) {
	alice := deployment.NewUser(t, "tSyncArchive02alice", "hs1")
...
func testArchivedRoomsHistory(t *testing.T, deployment *docker.Deployment) {
	alice := deployment.NewUser(t, "tSyncArchive03alice", "hs1")
	bob := deployment.NewUser(t, "tSyncArchive03bob", "hs1")
...
func testOlderLeftRoomsNotInLeaveSection(t *testing.T, deployment *docker.Deployment) {
	alice := deployment.NewUser(t, "tSyncArchive04alice", "hs1")
	bob := deployment.NewUser(t, "tSyncArchive04bob", "hs1")
...
//  restricted (SYN-662)
func testLeaveEventVisibility(t *testing.T, deployment *docker.Deployment) {
	...
	alice := deployment.NewUser(t, "tSyncArchive05alice", "hs1")
	bob := deployment.NewUser(t, "tSyncArchive05bob", "hs1")
...
func testLeaveEventInviteRejection(t *testing.T, deployment *docker.Deployment) {
	alice := deployment.NewUser(t, "tSyncArchive06alice", "hs1")
	bob := deployment.NewUser(t, "tSyncArchive06bob", "hs1")
