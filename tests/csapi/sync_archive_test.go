...
func TestSyncArchive(t *testing.T) {
	...
	t.Run("Parallel", func(t *testing.T) {
		...
		t.Run("SyncLeaveSection", func(t *testing.T) {
			...
			alice := deployment.RegisterUser(t, "hs1", "tSyncArchive01alice", alicePassword, false)
		...
		t.Run("GappedSyncLeaveSection", func(t *testing.T) {
			// formerly TestGappedSyncLeaveSection
			// with users: @tSyncArchive02alice:hs1
			runtime.SkipIf(t, runtime.Dendrite) // FIXME: https://github.com/matrix-org/dendrite/issues/1323
			t.Parallel()

			alice := deployment.RegisterUser(t, "hs1", "tSyncArchive02alice", alicePassword, false)
		...
		t.Run("ArchivedRoomsHistory", func(t *testing.T) {
			// formerly TestArchivedRoomsHistory
			// with users: @tSyncArchive03alice:hs1 and @tSyncArchive03bob:hs1
			runtime.SkipIf(t, runtime.Dendrite) // FIXME: https://github.com/matrix-org/dendrite/issues/1323
			t.Parallel()

			alice := deployment.RegisterUser(t, "hs1", "tSyncArchive03alice", alicePassword, false)
			bob := deployment.RegisterUser(t, "hs1", "tSyncArchive03bob", bobPassword, false)
		...
		t.Run("OlderLeftRoomsNotInLeaveSection", func(t *testing.T) {
			// formerly TestOlderLeftRoomsNotInLeaveSection
			// with users: @tSyncArchive04alice:hs1 and @tSyncArchive04bob:hs1
			runtime.SkipIf(t, runtime.Dendrite) // FIXME: https://github.com/matrix-org/dendrite/issues/1323
			t.Parallel()

			alice := deployment.RegisterUser(t, "hs1", "tSyncArchive04alice", alicePassword, false)
			bob := deployment.RegisterUser(t, "hs1", "tSyncArchive04bob", bobPassword, false)
		...
		//  restricted (SYN-662)
		t.Run("LeaveEventVisibility", func(t *testing.T) {
			// formerly TestLeaveEventVisibility
			// with users: @tSyncArchive05alice:hs1 and @tSyncArchive05bob:hs1
			runtime.SkipIf(t, runtime.Dendrite) // FIXME: https://github.com/matrix-org/dendrite/issues/1323
			t.Parallel()
			...
			alice := deployment.RegisterUser(t, "hs1", "tSyncArchive05alice", alicePassword, false)
			bob := deployment.RegisterUser(t, "hs1", "tSyncArchive05bob", bobPassword, false)
		...
		t.Run("LeaveEventInviteRejection", func(t *testing.T) {
			// formerly TestLeaveEventInviteRejection
			// with users: @tSyncArchive06alice:hs1 and @tSyncArchive06bob:hs1
			runtime.SkipIf(t, runtime.Dendrite) // FIXME: https://github.com/matrix-org/dendrite/issues/1323
			t.Parallel()
			alice := deployment.RegisterUser(t, "hs1", "tSyncArchive06alice", alicePassword, false)
			bob := deployment.RegisterUser(t, "hs1", "tSyncArchive06bob", bobPassword, false)
