...
func TestRoomHierarchy(t *testing.T) {
	...
	t.Run("parallel", func(t *testing.T) {
		...
		t.Run("ClientSpacesSummary", func(t *testing.T) {
			// formerly TestClientSpacesSummary
			// users needed: @alice:hs1 and bob:hs1
			// was using BlueprintOneToOneRoom
			t.Parallel()
		...
		t.Run("ClientSpacesSummaryJoinRules", func(t *testing.T) {
			// formerly TestClientSpacesSummaryJoinRules
			// users needed: @alice:hs1 and @bob:hs1
			// was using BlueprintOneToOneRoom
			t.Parallel()
			// create the rooms
		...
		t.Run("FederatedClientSpaces", func(t *testing.T) {
			// formerly TestFederatedClientSpaces
			// users needed: @alice:hs1 and @charlie:hs2(was @bob:hs2)
			// was using BlueprintFederationOneToOneRoom
			t.Parallel()
			...
			r2 := charlie.CreateRoom(t, worldReadable)
			ss2 := charlie.CreateRoom(t, worldReadableSpace)
			r3 := charlie.CreateRoom(t, worldReadable)
			...
			ss2ToR4 := eventKey(ss2, r4, spaceChildEventType)
			charlie.SendEventSynced(t, ss2, b.Event{
				Type:     spaceChildEventType,
				StateKey: &r4,
				Content: map[string]interface{}{
					"via": []string{"hs1"},
