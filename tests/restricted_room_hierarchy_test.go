...
func TestRestrictedRoomsHierarchy(t *testing.T) {
	...
	t.Run("parallel", func(t *testing.T) {
		...
		t.Run("RestrictedRoomsSpacesSummaryLocal", func(t *testing.T) {
			// formerly TestRestrictedRoomsSpacesSummaryLocal
		...
		t.Run("RestrictedRoomsSpacesSummaryFederation", func(t *testing.T) {
			//formerly TestRestrictedRoomsSpacesSummaryFederation
